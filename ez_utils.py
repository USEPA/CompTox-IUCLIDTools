...
def get_oht_classes(oht_type):
    module_name = f"entity_models.{oht_type.lower()}_6_8.models"
...
def create_xml_serializer(oht_type):
    ...
    try:
        context = XmlContext(models_package=f"entity_models.{oht_type.lower()}_6_8.models")
...
def load_and_introspect_models(model_names):
    ...
    for model_name in model_names:
        module_name = f"entity_models.{model_name.lower()}_6_8.models"
        module = importlib.import_module(module_name)
