...
from entity_models_6_6.toxicitytoterrestrialarthropods_6_5.models.common_types_oecd_v7 import (
    A03,
    A36,
    E04,
    E15,
...
from entity_models_6_6.toxicitytoterrestrialarthropods_6_5.models.platform_fields import (
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ToxicityToTerrestrialArthropods/7.0"
...
class EndpointStudyRecordToxicityToTerrestrialArthropodsAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ToxicityToTerrestrialArthropods/7.0",
        },
    )
...
@dataclass
class EndpointStudyRecordToxicityToTerrestrialArthropodsOverallRemarksAttachmentsAttachedBackgroundMaterialEntryType(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordToxicityToTerrestrialArthropodsResultsAndDiscussionEffectConcentrationsEntryConfInterval(
    BasePhysicalQuantityRangeField
):
    class Meta:
        global_type = False
...
class EndpointStudyRecordToxicityToTerrestrialArthropodsResultsAndDiscussionEffectConcentrationsEntryEffectConc(
    ...
    unit_code: Optional[Pg660821] = field(
        default=None,
        metadata={
            "name": "unitCode",
            "type": "Element",
...
class EndpointStudyRecordToxicityToTerrestrialArthropodsMaterialsAndMethodsTestConditions:
    ...
    ph_if_soil_study: List[MultilingualTextFieldMultiLine] = field(
        default_factory=list,
        metadata={
            "name": "PhIfSoilStudy",
            "type": "Element",
...
class EndpointStudyRecordToxicityToTerrestrialArthropodsOverallRemarksAttachmentsAttachedBackgroundMaterialEntry(
    ...
    type_value: Optional[
        EndpointStudyRecordToxicityToTerrestrialArthropodsOverallRemarksAttachmentsAttachedBackgroundMaterialEntryType
    ] = field(
        default=None,
        metadata={
            "name": "Type",
...
class EndpointStudyRecordToxicityToTerrestrialArthropodsResultsAndDiscussionEffectConcentrationsEntry(
    ...
    conf_interval: Optional[
        EndpointStudyRecordToxicityToTerrestrialArthropodsResultsAndDiscussionEffectConcentrationsEntryConfInterval
    ] = field(
        default=None,
        metadata={
            "name": "ConfInterval",
...
class EndpointStudyRecordToxicityToTerrestrialArthropodsResultsAndDiscussion:
    ...
    toxic_reference: List[MultilingualTextFieldLarge] = field(
        default_factory=list,
        metadata={
            "name": "ToxicReference",
            "type": "Element",
