...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-CorrosiveToMetals/8.0"
...
class EndpointStudyRecordCorrosiveToMetalsAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-CorrosiveToMetals/8.0",
        },
    )
