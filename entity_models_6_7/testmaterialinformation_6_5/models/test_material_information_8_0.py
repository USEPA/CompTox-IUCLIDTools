...
from entity_models_6_7.testmaterialinformation_6_5.models.common_types_domain_v8 import (
    A101,
    N24,
    Pg660011,
    Pg660016,
)
from entity_models_6_7.testmaterialinformation_6_5.models.platform_fields import (
...
__NAMESPACE__ = (
    "http://iuclid6.echa.europa.eu/namespaces/TEST_MATERIAL_INFORMATION/8.0"
)
...
class TestMaterialInformationCompositionCompositionListEntryConcentration(
    ...
    unit_code: Optional[N24] = field(
        ...
        metadata={
            "name": "unitCode",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/TEST_MATERIAL_INFORMATION/8.0",
        },
    )
