...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-BiodegradationInWaterAndSedimentSimulationTests/8.0"
...
class EndpointStudyRecordBiodegradationInWaterAndSedimentSimulationTestsAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-BiodegradationInWaterAndSedimentSimulationTests/8.0",
        },
    )
...
@dataclass
class EndpointStudyRecordBiodegradationInWaterAndSedimentSimulationTestsResultsAndDiscussionMeanTotalRecoveryEntrySamplingTime(
    BasePhysicalQuantityField
):
    class Meta:
        global_type = False
