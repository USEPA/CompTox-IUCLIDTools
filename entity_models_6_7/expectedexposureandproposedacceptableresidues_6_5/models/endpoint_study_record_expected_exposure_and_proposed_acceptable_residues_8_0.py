...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ExpectedExposureAndProposedAcceptableResidues/8.0"
...
class EndpointStudyRecordExpectedExposureAndProposedAcceptableResiduesAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ExpectedExposureAndProposedAcceptableResidues/8.0",
        },
    )
