...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EndocrineDisrupterScreeningInVitro/9.0"
...
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EndocrineDisrupterScreeningInVitro/9.0",
        },
    )
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroMaterialsAndMethodsModelAndSoftware:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheApplicabilityDomain(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheSpaceDefinedByTheTrainingSetOfTheModel(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntrySource(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295Legislation:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsUncertainty(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAnyOtherInformationOnResultsInclTables:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295(
    BaseDataProtectionField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntry(
    RepeatableEntryType
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalData:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordEndocrineDisrupterScreeningInVitroResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictions:
    class Meta:
        global_type = False
