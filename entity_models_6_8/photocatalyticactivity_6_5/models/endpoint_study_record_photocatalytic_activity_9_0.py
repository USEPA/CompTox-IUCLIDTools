...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-PhotocatalyticActivity/9.0"
...
class EndpointStudyRecordPhotocatalyticActivityAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-PhotocatalyticActivity/9.0",
        },
    )
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityMaterialsAndMethodsModelAndSoftware:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityOverallRemarksAttachmentsAttachedBackgroundMaterialEntryType(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheApplicabilityDomain(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheSpaceDefinedByTheTrainingSetOfTheModel(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntrySource(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295Legislation:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsUncertainty(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295(
    BaseDataProtectionField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntry(
    RepeatableEntryType
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalData:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhotocatalyticActivityResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictions:
    class Meta:
        global_type = False
