...
from entity_models_6_4.acutetoxicityinhalation_6_5.models.common_types_oecd_v5 import (
    A03,
    A36,
    E105,
    N64,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AcuteToxicityInhalation/5.0"
...
class EndpointStudyRecordAcuteToxicityInhalationMaterialsAndMethodsAdministrationExposureGeometricStandardDeviation:
    ...
    lower_qualifier: Optional[str] = field(
        ...
        metadata={
            "name": "lowerQualifier",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AcuteToxicityInhalation/5.0",
        },
    )
...
class EndpointStudyRecordAcuteToxicityInhalationMaterialsAndMethodsAdministrationExposure:
    ...
    details_on_inhalation_exposure: List[str] = field(
        default_factory=list,
        metadata={
    ...
    remarks_on_duration: List[str] = field(
        default_factory=list,
        metadata={
