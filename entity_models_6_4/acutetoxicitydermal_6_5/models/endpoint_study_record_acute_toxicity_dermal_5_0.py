...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AcuteToxicityDermal/5.0"
...
class EndpointStudyRecordAcuteToxicityDermalMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AcuteToxicityDermal/5.0",
        },
    )
...
class EndpointStudyRecordAcuteToxicityDermalMaterialsAndMethodsAdministrationExposure:
    ...
    details_on_dermal_exposure: List[str] = field(
        default_factory=list,
        metadata={
