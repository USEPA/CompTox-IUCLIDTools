...
from entity_models_6_4.epidemiologicaldata_6_5.models.common_types_oecd_v5 import (
    A36,
    N64,
    N78,
    T167,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EpidemiologicalData/5.0"
...
class EndpointStudyRecordEpidemiologicalDataApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EpidemiologicalData/5.0",
        },
    )
...
class EndpointStudyRecordEpidemiologicalDataResultsAndDiscussion:
    ...
    strengths_weaknesses: List[str] = field(
        default_factory=list,
        metadata={
