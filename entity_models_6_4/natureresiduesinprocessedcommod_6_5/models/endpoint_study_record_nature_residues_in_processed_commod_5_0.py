...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-NatureResiduesInProcessedCommod/5.0"
...
class EndpointStudyRecordNatureResiduesInProcessedCommodApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-NatureResiduesInProcessedCommod/5.0",
        },
    )
...
class EndpointStudyRecordNatureResiduesInProcessedCommodMaterialsAndMethodsSamplingAndAnalyticalMethodology:
    ...
    details_on_sample_handling_and_storage_conditions: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordNatureResiduesInProcessedCommodMaterialsAndMethodsStudyDesign:
    ...
    experimental_procedure: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordNatureResiduesInProcessedCommodResultsAndDiscussion:
    ...
    other_details_on_trrs: List[str] = field(
        default_factory=list,
        metadata={
