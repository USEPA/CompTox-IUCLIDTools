...
from entity_models_6_4.toxicitytosoilmicroorganisms_6_5.models.common_types_oecd_v5 import (
    A03,
    A36,
    E04,
    E15,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ToxicityToSoilMicroorganisms/5.0"
...
class EndpointStudyRecordToxicityToSoilMicroorganismsMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ToxicityToSoilMicroorganisms/5.0",
        },
    )
...
class EndpointStudyRecordToxicityToSoilMicroorganismsMaterialsAndMethodsTestConditions:
    ...
    organic_carbon_content: Optional[str] = field(
        default=None,
        metadata={
    ...
    nitrogen_content: Optional[str] = field(
        default=None,
        metadata={
