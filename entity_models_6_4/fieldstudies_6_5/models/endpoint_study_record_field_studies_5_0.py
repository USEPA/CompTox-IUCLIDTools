...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-FieldStudies/5.0"
...
class EndpointStudyRecordFieldStudiesApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-FieldStudies/5.0",
        },
    )
...
@dataclass
class EndpointStudyRecordFieldStudiesDataSourceDataAccess:
    class Meta:
        global_type = False
...
class EndpointStudyRecordFieldStudiesMaterialsAndMethods:
    ...
    type_of_measurement: List[str] = field(
        default_factory=list,
        metadata={
