...
from entity_models_6_4.developmentaltoxicityteratogenicity_6_5.models.common_types_oecd_v5 import (
    A03,
    A36,
    E105,
    N64,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DevelopmentalToxicityTeratogenicity/5.0"
...
class EndpointStudyRecordDevelopmentalToxicityTeratogenicityApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DevelopmentalToxicityTeratogenicity/5.0",
        },
    )
...
class EndpointStudyRecordDevelopmentalToxicityTeratogenicityMaterialsAndMethodsExaminations:
    ...
    maternal_examinations: List[str] = field(
        default_factory=list,
        metadata={
    ...
    ovaries_and_uterine_content: List[str] = field(
        default_factory=list,
        metadata={
    ...
    fetal_examinations: List[str] = field(
        default_factory=list,
        metadata={
    ...
    historical_control_data: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordDevelopmentalToxicityTeratogenicityResultsAndDiscussionResultsFetusesFetalAbnormalitiesFetalAbnormalitiesEntry:
    ...
    description_incidence_and_severity: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordDevelopmentalToxicityTeratogenicityResultsAndDiscussionResultsMaternalAnimalsMaternalDevelopmentalToxicity:
    ...
    description_incidence_and_severity_number_of_abortions: List[str] = field(
        default_factory=list,
        metadata={
    ...
    description_incidence_and_severity_early_or_late_resorptions: List[str] = (
        field(
            default_factory=list,
            metadata={
    ...
    description_incidence_and_severity_dead_fetuses: List[str] = field(
        default_factory=list,
        metadata={
    ...
    results_details_maternal: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordDevelopmentalToxicityTeratogenicityResultsAndDiscussionResultsFetuses:
    ...
    description_incidence_and_severity_changes_in_sex_ratio: List[str] = field(
        default_factory=list,
        metadata={
    ...
    description_incidence_and_severity_external_malformations: List[str] = (
        field(
            default_factory=list,
            metadata={
    ...
    description_incidence_and_severity_skeletal_malformations: List[str] = (
        field(
            default_factory=list,
            metadata={
    ...
    description_incidence_and_severity_visceral_malformations: List[str] = (
        field(
            default_factory=list,
            metadata={
    ...
    results_details_develop: List[str] = field(
        default_factory=list,
        metadata={
