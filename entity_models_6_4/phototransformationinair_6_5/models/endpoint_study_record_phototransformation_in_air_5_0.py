...
from entity_models_6_4.phototransformationinair_6_5.models.common_types_oecd_v5 import (
    A03,
    A36,
    A102,
    C113,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-PhototransformationInAir/5.0"
...
class EndpointStudyRecordPhototransformationInAirMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-PhototransformationInAir/5.0",
        },
    )
