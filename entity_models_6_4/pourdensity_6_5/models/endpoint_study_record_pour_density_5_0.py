...
from entity_models_6_4.pourdensity_6_5.models.common_types_oecd_v5 import (
    A36,
    N64,
    N78,
    Y143,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-PourDensity/5.0"
...
class EndpointStudyRecordPourDensityApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-PourDensity/5.0",
        },
    )
...
@dataclass
class EndpointStudyRecordPourDensityDataSourceDataAccess:
    class Meta:
        global_type = False
