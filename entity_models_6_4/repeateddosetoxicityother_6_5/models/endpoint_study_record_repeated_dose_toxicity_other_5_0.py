...
from entity_models_6_4.repeateddosetoxicityother_6_5.models.common_types_oecd_v5 import (
    A03,
    A36,
    E105,
    N64,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-RepeatedDoseToxicityOther/5.0"
...
class EndpointStudyRecordRepeatedDoseToxicityOtherApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-RepeatedDoseToxicityOther/5.0",
        },
    )
