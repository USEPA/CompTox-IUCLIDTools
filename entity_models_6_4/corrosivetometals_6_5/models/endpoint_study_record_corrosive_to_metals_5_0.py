...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-CorrosiveToMetals/5.0"
...
class EndpointStudyRecordCorrosiveToMetalsMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-CorrosiveToMetals/5.0",
        },
    )
...
class EndpointStudyRecordCorrosiveToMetalsResultsAndDiscussionTestResultsEntry:
    ...
    corrosion_rate_mm_year: Optional[str] = field(
        default=None,
        metadata={
    ...
    uniform_corrosion_exposure_time_days: Optional[str] = field(
        default=None,
        metadata={
    ...
    uniform_corrosion_mass_loss: Optional[str] = field(
        default=None,
        metadata={
    ...
    localised_corrosion_exposure_time_days: Optional[str] = field(
        default=None,
        metadata={
    ...
    localised_corrosion_intrusion_depth_m: Optional[str] = field(
        default=None,
        metadata={
