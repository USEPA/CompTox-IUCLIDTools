...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EffectivenessAgainstTargetOrganisms/5.0"
...
class EndpointStudyRecordEffectivenessAgainstTargetOrganismsApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EffectivenessAgainstTargetOrganisms/5.0",
        },
    )
...
@dataclass
class EndpointStudyRecordEffectivenessAgainstTargetOrganismsGeneralInformationInformationOnApplicationOfBiocidalProductMethodOfApplication:
    class Meta:
        global_type = False
...
class EndpointStudyRecordEffectivenessAgainstTargetOrganismsGeneralInformationGeneralInformationOnEffectiveness:
    ...
    effects_on_target_organisms: List[str] = field(
        default_factory=list,
        metadata={
    ...
    details_on_mode_of_action: List[str] = field(
        default_factory=list,
        metadata={
    ...
    possible_occurrence_of_resistance: List[str] = field(
        default_factory=list,
        metadata={
    ...
    management_strategies_to_avoid_resistance: List[str] = field(
        default_factory=list,
        metadata={
    ...
    any_other_known_limitations_and_management_strategies: List[str] = field(
        default_factory=list,
        metadata={
...
@dataclass
class EndpointStudyRecordEffectivenessAgainstTargetOrganismsGeneralInformationInformationOnApplicationOfBiocidalProduct:
    class Meta:
        global_type = False
...
class EndpointStudyRecordEffectivenessAgainstTargetOrganismsGeneralInformationInformationOnIntendedUseAndApplication:
    ...
    field_of_use_envisaged_user: List[str] = field(
        default_factory=list,
        metadata={
