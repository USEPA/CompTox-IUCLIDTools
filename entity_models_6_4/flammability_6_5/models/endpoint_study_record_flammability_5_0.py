...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Flammability/5.0"
...
class EndpointStudyRecordFlammabilityMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Flammability/5.0",
        },
    )
...
@dataclass
class EndpointStudyRecordFlammabilityDataSourceDataAccess:
    class Meta:
        global_type = False
...
class EndpointStudyRecordFlammabilityResultsAndDiscussionFlammableSolidsEntry:
    ...
    moisture_wt: Optional[str] = field(
        default=None,
        metadata={
            "name": "MoistureWt",
            "type": "Element",
...
class EndpointStudyRecordFlammabilityResultsAndDiscussionPyrophoricLiquidsEntry:
    ...
    relative_air_humidity: Optional[str] = field(
        default=None,
        metadata={
...
class EndpointStudyRecordFlammabilityResultsAndDiscussionSelfHeatingSubstancesMixturesEntry:
    ...
    max_temp_reached: Optional[str] = field(
        default=None,
        metadata={
            "name": "MaxTempReached",
            "type": "Element",
    ...
    induction_time_h: Optional[str] = field(
        default=None,
        metadata={
            "name": "InductionTimeH",
            "type": "Element",
