...
from entity_models_6_4.oxidisingproperties_6_5.models.common_types_oecd_v5 import (
    A36,
    C113,
    N64,
    N78,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-OxidisingProperties/5.0"
...
class EndpointStudyRecordOxidisingPropertiesMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-OxidisingProperties/5.0",
        },
    )
