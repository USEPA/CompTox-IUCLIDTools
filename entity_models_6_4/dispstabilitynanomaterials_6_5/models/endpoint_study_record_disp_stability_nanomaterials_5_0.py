...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DispStabilityNanomaterials/5.0"
...
class EndpointStudyRecordDispStabilityNanomaterialsMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DispStabilityNanomaterials/5.0",
        },
    )
...
class EndpointStudyRecordDispStabilityNanomaterialsMaterialsAndMethodsPreparationOfTestSampleTestMedium:
    ...
    details_on_test_sample_test_medium: List[str] = field(
        default_factory=list,
        metadata={
