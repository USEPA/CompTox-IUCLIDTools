...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-RespiratorySensitisation/5.0"
...
class EndpointStudyRecordRespiratorySensitisationMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-RespiratorySensitisation/5.0",
        },
    )
...
class EndpointStudyRecordRespiratorySensitisationResultsAndDiscussion:
    ...
    pos_control_results: List[str] = field(
        default_factory=list,
        metadata={
    ...
    neg_control_results: List[str] = field(
        default_factory=list,
        metadata={
