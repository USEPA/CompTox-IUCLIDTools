...
from entity_models_6_4.toxicitytobirds_6_5.models.common_types_oecd_v5 import (
    A03,
    A36,
    E30,
    E105,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ToxicityToBirds/5.0"
...
class EndpointStudyRecordToxicityToBirdsMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ToxicityToBirds/5.0",
        },
    )
...
class EndpointStudyRecordToxicityToBirdsMaterialsAndMethodsExaminations:
    ...
    details_on_examinations_and_observations: List[str] = field(
        default_factory=list,
        metadata={
    ...
    details_on_reproductive_parameters: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordToxicityToBirdsMaterialsAndMethodsStudyDesign:
    ...
    nominal_and_measured_doses_concentrations: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordToxicityToBirdsMaterialsAndMethodsTestMaterials:
    ...
    details_on_preparation_and_analysis_of_diet: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordToxicityToBirdsResultsAndDiscussion:
    ...
    repellency_factors: List[str] = field(
        default_factory=list,
        metadata={
    ...
    mortality_and_sub_lethal_effects: List[str] = field(
        default_factory=list,
        metadata={
    ...
    effects_on_reproduction: List[str] = field(
        default_factory=list,
        metadata={
    ...
    further_details_on_results: List[str] = field(
        default_factory=list,
        metadata={
    ...
    reported_statistics_and_error_estimates: List[str] = field(
        default_factory=list,
        metadata={
