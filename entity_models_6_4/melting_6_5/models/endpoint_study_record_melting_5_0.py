...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Melting/5.0"
...
class EndpointStudyRecordMeltingApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Melting/5.0",
        },
    )
...
@dataclass
class EndpointStudyRecordMeltingAdministrativeDataEndpoint:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordMeltingDataSourceDataAccess:
    class Meta:
        global_type = False
