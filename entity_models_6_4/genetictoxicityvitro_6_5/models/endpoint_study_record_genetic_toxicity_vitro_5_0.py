...
from entity_models_6_4.genetictoxicityvitro_6_5.models.common_types_oecd_v5 import (
    A36,
    N64,
    N78,
    T30,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-GeneticToxicityVitro/5.0"
...
class EndpointStudyRecordGeneticToxicityVitroApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-GeneticToxicityVitro/5.0",
        },
    )
...
class EndpointStudyRecordGeneticToxicityVitroMaterialsAndMethodsMethodSpeciesStrainEntry:
    ...
    details_on_mammalian_cell_lines_if_applicable: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordGeneticToxicityVitroMaterialsAndMethodsMethod:
    ...
    cytokinesis_block_if_used: List[str] = field(
        default_factory=list,
        metadata={
    ...
    metabolic_activation_system: List[str] = field(
        default_factory=list,
        metadata={
    ...
    test_concentrations_with_justification_for_top_dose: List[str] = field(
        default_factory=list,
        metadata={
    ...
    details_on_test_system_and_conditions: List[str] = field(
        default_factory=list,
        metadata={
    ...
    rationale_for_test_conditions: List[str] = field(
        default_factory=list,
        metadata={
