...
from entity_models_6_4.carcinogenicity_6_5.models.common_types_oecd_v5 import (
    A03,
    A36,
    E105,
    N64,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Carcinogenicity/5.0"
...
class EndpointStudyRecordCarcinogenicityApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Carcinogenicity/5.0",
        },
    )
...
class EndpointStudyRecordCarcinogenicityResultsAndDiscussionResultsOfExaminations:
    ...
    relevance_of_carcinogenic_effects_potential: List[str] = field(
        default_factory=list,
        metadata={
