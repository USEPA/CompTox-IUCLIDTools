...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-BiodegradationInWaterScreeningTests/5.0"
...
class EndpointStudyRecordBiodegradationInWaterScreeningTestsMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-BiodegradationInWaterScreeningTests/5.0",
        },
    )
...
class EndpointStudyRecordBiodegradationInWaterScreeningTestsResultsAndDiscussion:
    ...
    prelim_study_rs: List[str] = field(
        default_factory=list,
        metadata={
            "name": "PrelimStudyRs",
            "type": "Element",
