...
from entity_models_6_4.crystallinephase_6_5.models.common_types_oecd_v5 import (
    A36,
    N64,
    N78,
    Y143,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-CrystallinePhase/5.0"
...
class EndpointStudyRecordCrystallinePhaseApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-CrystallinePhase/5.0",
        },
    )
...
class EndpointStudyRecordCrystallinePhaseResultsAndDiscussionCrystallinePhaseEntry:
    ...
    crystallographic_planes: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordCrystallinePhaseResultsAndDiscussion:
    ...
    crystallographic_composition: List[str] = field(
        default_factory=list,
        metadata={
