...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DirectObservationsClinicalCases/5.0"
...
class EndpointStudyRecordDirectObservationsClinicalCasesApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DirectObservationsClinicalCases/5.0",
        },
    )
...
class EndpointStudyRecordDirectObservationsClinicalCasesResultsAndDiscussion:
    ...
    effectivity_medical_treatment: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordDirectObservationsClinicalCasesMaterialsAndMethodsMethod:
    ...
    medical_treatment: List[str] = field(
        default_factory=list,
        metadata={
