...
from entity_models_6_4.surfacechemistry_6_5.models.common_types_oecd_v5 import (
    A36,
    N64,
    N78,
    Y143,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-SurfaceChemistry/5.0"
...
class EndpointStudyRecordSurfaceChemistryApplicantSummaryAndConclusion:
    ...
    conclusions: List[str] = field(
        ...
        metadata={
            "name": "Conclusions",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-SurfaceChemistry/5.0",
        },
    )
...
class EndpointStudyRecordSurfaceChemistryResultsAndDiscussionCoating:
    ...
    coating_description: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordSurfaceChemistryResultsAndDiscussionFunctionalisation:
    ...
    functionalisation_description: List[str] = field(
        default_factory=list,
        metadata={
