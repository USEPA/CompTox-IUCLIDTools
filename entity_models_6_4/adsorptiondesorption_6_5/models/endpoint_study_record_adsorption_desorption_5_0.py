...
from entity_models_6_4.adsorptiondesorption_6_5.models.common_types_oecd_v5 import (
    A03,
    A36,
    A102,
    C113,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AdsorptionDesorption/5.0"
...
class EndpointStudyRecordAdsorptionDesorptionMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AdsorptionDesorption/5.0",
        },
    )
...
class EndpointStudyRecordAdsorptionDesorptionMaterialsAndMethodsStudyDesignHplcmethod:
    ...
    details_on_study_design_hplc_method: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordAdsorptionDesorptionResultsAndDiscussionResultsHplcMethod:
    ...
    details_on_results_hplc_method: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordAdsorptionDesorptionMaterialsAndMethodsStudyDesignBatchEquilibriumOrOtherMethod:
    ...
    details_on_matrix: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordAdsorptionDesorptionResultsAndDiscussionResultsBatchEquilibriumOrOtherMethod:
    ...
    adsorption_and_desorption_constants: List[str] = field(
        default_factory=list,
        metadata={
    ...
    recovery_of_test_material: List[str] = field(
        default_factory=list,
        metadata={
    ...
    details_on_results_batch_equilibrium_method: List[str] = field(
        default_factory=list,
        metadata={
