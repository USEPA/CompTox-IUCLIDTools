...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EyeIrritation/5.0"
...
class EndpointStudyRecordEyeIrritationMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EyeIrritation/5.0",
        },
    )
...
@dataclass
class EndpointStudyRecordEyeIrritationDataSourceDataAccess:
    class Meta:
        global_type = False
...
class EndpointStudyRecordEyeIrritationMaterialsAndMethodsTestSystem:
    ...
    duration_of_post_treatment_incubation_in_vitro: List[str] = field(
        default_factory=list,
        metadata={
