...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ToxicityToSoilMacroorganismsExceptArthropods/5.0"
...
class EndpointStudyRecordToxicityToSoilMacroorganismsExceptArthropodsMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ToxicityToSoilMacroorganismsExceptArthropods/5.0",
        },
    )
