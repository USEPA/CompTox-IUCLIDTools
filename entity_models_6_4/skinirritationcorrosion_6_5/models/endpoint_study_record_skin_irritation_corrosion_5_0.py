...
from entity_models_6_4.skinirritationcorrosion_6_5.models.common_types_oecd_v5 import (
    A36,
    N64,
    N78,
    T025,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-SkinIrritationCorrosion/5.0"
...
class EndpointStudyRecordSkinIrritationCorrosionMaterialsAndMethodsAnyOtherInformationOnMaterialsAndMethodsInclTables:
    ...
    other_information: List[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-SkinIrritationCorrosion/5.0",
        },
    )
...
class EndpointStudyRecordSkinIrritationCorrosionMaterialsAndMethodsInVitroTestSystem:
    ...
    details_on_animal_used_as_source_of_test_system: List[str] = field(
        default_factory=list,
        metadata={
    ...
    justification_for_test_system_used: List[str] = field(
        default_factory=list,
        metadata={
    ...
    details_on_test_system: List[str] = field(
        default_factory=list,
        metadata={
    ...
    amount_concentration_applied: List[str] = field(
        default_factory=list,
        metadata={
    ...
    duration_of_post_treatment_incubation_if_applicable: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordSkinIrritationCorrosionMaterialsAndMethodsTestSystem:
    ...
    observation_period: List[str] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordSkinIrritationCorrosionResultsAndDiscussionInVivo:
    ...
    irritation_corrosion_response_data: List[str] = field(
        default_factory=list,
        metadata={
