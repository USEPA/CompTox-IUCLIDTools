...
from entity_models_6_4.testmaterialinformation_6_5.models.common_types_domain_v5 import (
    A101,
    N24,
    Pg660011,
    Pg660016,
...
__NAMESPACE__ = (
    "http://iuclid6.echa.europa.eu/namespaces/TEST_MATERIAL_INFORMATION/5.0"
)
...
class TestMaterialInformationCompositionCompositionListEntryConcentration:
    ...
    unit_code: Optional[N24] = field(
        ...
        metadata={
            "name": "unitCode",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/TEST_MATERIAL_INFORMATION/5.0",
        },
    )
...
class TestMaterialInformationCompositionOtherCharacteristics:
    ...
    details_on_test_material: List[str] = field(
        default_factory=list,
        metadata={
    ...
    confidential_details_on_test_material: List[str] = field(
        default_factory=list,
        metadata={
