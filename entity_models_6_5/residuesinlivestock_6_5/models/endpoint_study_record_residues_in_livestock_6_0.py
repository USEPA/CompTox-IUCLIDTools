...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ResiduesInLivestock/6.0"
...
class EndpointStudyRecordResiduesInLivestockAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ResiduesInLivestock/6.0",
        },
    )
...
class EndpointStudyRecordResiduesInLivestockMaterialsAndMethodsAdministrationExposure:
    ...
    duration_and_frequency_of_dosing: List[MultilingualTextFieldMultiLine] = (
        field(
            default_factory=list,
            metadata={
    ...
    doses_concentrations: List[MultilingualTextFieldMultiLine] = field(
        default_factory=list,
        metadata={
...
class EndpointStudyRecordResiduesInLivestockResultsAndDiscussionResidueDataEntry(
    ...
    sampling_time: List[MultilingualTextFieldSmall] = field(
        default_factory=list,
        metadata={
            "name": "SamplingTime",
            "type": "Element",
    ...
    dose_feeding_level: List[MultilingualTextFieldSmall] = field(
        default_factory=list,
        metadata={
