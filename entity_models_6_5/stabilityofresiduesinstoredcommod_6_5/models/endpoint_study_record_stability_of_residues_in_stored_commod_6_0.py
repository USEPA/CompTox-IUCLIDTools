...
from entity_models_6_5.stabilityofresiduesinstoredcommod_6_5.models.common_types_oecd_v6 import (
    A36,
    C1112,
    N64,
    N78,
...
from entity_models_6_5.stabilityofresiduesinstoredcommod_6_5.models.platform_fields import (
    AttachmentListField,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-StabilityOfResiduesInStoredCommod/6.0"
...
class EndpointStudyRecordStabilityOfResiduesInStoredCommodAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-StabilityOfResiduesInStoredCommod/6.0",
        },
    )
...
class EndpointStudyRecordStabilityOfResiduesInStoredCommodMaterialsAndMethodsStudyDesign:
    ...
    storage_conditions: List[MultilingualTextFieldLarge] = field(
        default_factory=list,
        metadata={
