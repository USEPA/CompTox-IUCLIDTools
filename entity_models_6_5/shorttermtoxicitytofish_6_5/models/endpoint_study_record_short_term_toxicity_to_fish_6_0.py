...
from entity_models_6_5.shorttermtoxicitytofish_6_5.models.common_types_oecd_v6 import (
    A03,
    A36,
    E01,
    E02,
...
from entity_models_6_5.shorttermtoxicitytofish_6_5.models.platform_fields import (
    AttachmentListField,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ShortTermToxicityToFish/6.0"
...
class EndpointStudyRecordShortTermToxicityToFishAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ShortTermToxicityToFish/6.0",
        },
    )
...
class EndpointStudyRecordShortTermToxicityToFishResultsAndDiscussionAnyOtherInformationOnResultsInclTables:
    ...
    sublethal_observations_clinical_signs: List[MultilingualTextField] = field(
        default_factory=list,
        metadata={
            "name": "SublethalObservationsClinicalSigns",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ShortTermToxicityToFish/6.0",
        },
    )
