...
from entity_models_6_5.substance_6_5.models.common_types_domain_v6 import (
    A31,
    N08,
    N58,
    N64,
...
from entity_models_6_5.substance_6_5.models.platform_fields import (
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/SUBSTANCE/6.0"
...
class SubstanceTemplates:
    ...
    template: List[str] = field(
        ...
        metadata={
            "name": "Template",
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/SUBSTANCE/6.0",
        },
    )
