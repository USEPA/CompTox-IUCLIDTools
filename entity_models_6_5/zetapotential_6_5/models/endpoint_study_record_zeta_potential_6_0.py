...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ZetaPotential/6.0"
...
class EndpointStudyRecordZetaPotentialAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ZetaPotential/6.0",
        },
    )
