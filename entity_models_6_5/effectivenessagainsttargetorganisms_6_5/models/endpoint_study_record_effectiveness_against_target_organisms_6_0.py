...
from entity_models_6_5.effectivenessagainsttargetorganisms_6_5.models.common_types_oecd_v6 import (
    A36,
    C70,
    C109,
    C110,
...
from entity_models_6_5.effectivenessagainsttargetorganisms_6_5.models.platform_fields import (
    AttachmentListField,
...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EffectivenessAgainstTargetOrganisms/6.0"
...
class EndpointStudyRecordEffectivenessAgainstTargetOrganismsAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-EffectivenessAgainstTargetOrganisms/6.0",
        },
    )
