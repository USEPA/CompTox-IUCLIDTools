...
from ph_6_8.models.common_types_oecd_v9 import (
    A36,
    A102,
    N64,
    N78,
...
from ph_6_8.models.platform_fields import (
...
__NAMESPACE__ = (
    "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Ph/9.0"
)
...
class EndpointStudyRecordPhAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Ph/9.0",
        },
    )
...
@dataclass
class EndpointStudyRecordPhAdministrativeDataDataWaiving(BasePicklistField):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhAdministrativeDataEndpoint(BasePicklistField):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhAdministrativeDataPurposeFlag(BasePicklistField):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhAdministrativeDataReliability(BasePicklistField):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhDataSourceDataAccess(BasePicklistField):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhDataSourceDataProtectionClaimed(BasePicklistField):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhMaterialsAndMethodsModelAndSoftware:
    class Meta:
        global_type = False
...
class EndpointStudyRecordPhMaterialsAndMethodsTitrationOfAcidityAndAlkalinity:
    ...
    details_on_titrant_used: List[MultilingualTextFieldLarge] = field(
        default_factory=list,
        metadata={
...
@dataclass
class EndpointStudyRecordPhOverallRemarksAttachmentsAttachedBackgroundMaterialEntryType(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheApplicabilityDomain(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheSpaceDefinedByTheTrainingSetOfTheModel(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntrySource(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295Legislation:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsUncertainty(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295(
    BaseDataProtectionField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntry(
    RepeatableEntryType
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalData:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordPhResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictions:
    class Meta:
        global_type = False
