...
from vapour_6_8.models.common_types_oecd_v9 import (
    A30,
    A36,
    A102,
    N64,
...
from vapour_6_8.models.platform_fields import (
...
__NAMESPACE__ = (
    "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Vapour/9.0"
)
...
class EndpointStudyRecordVapourAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-Vapour/9.0",
        },
    )
...
@dataclass
class EndpointStudyRecordVapourAdministrativeDataEndpoint(BasePicklistField):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourDataSourceDataAccess(BasePicklistField):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourMaterialsAndMethodsModelAndSoftware:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourOverallRemarksAttachmentsAttachedBackgroundMaterialEntryType(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheApplicabilityDomain(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheSpaceDefinedByTheTrainingSetOfTheModel(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntrySource(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295Legislation:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsUncertainty(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295(
    BaseDataProtectionField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntry(
    RepeatableEntryType
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalData:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordVapourResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictions:
    class Meta:
        global_type = False
