...
from biodegradationinwaterandsedimentsimulationtests_6_8.models.common_types_oecd_v9 import (
    A03,
    A36,
    A102,
    C113,
...
from biodegradationinwaterandsedimentsimulationtests_6_8.models.platform_fields import (
    AttachmentListField,
