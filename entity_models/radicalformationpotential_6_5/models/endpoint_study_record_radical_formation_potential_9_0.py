...
__NAMESPACE__ = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-RadicalFormationPotential/9.0"
...
class EndpointStudyRecordRadicalFormationPotentialAdministrativeDataAttachedJustificationEntryReasonPurpose(
    ...
    value: Optional[Pg660009] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-RadicalFormationPotential/9.0",
        },
    )
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialMaterialsAndMethodsModelAndSoftware:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialOverallRemarksAttachmentsAttachedBackgroundMaterialEntryType(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheApplicabilityDomain(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsFitWithTheSpaceDefinedByTheTrainingSetOfTheModel(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntrySource(
    BasePicklistField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295Legislation:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsUncertainty(
    BasePicklistField
):
    class Meta:
        global_type = False
...
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionRadicalFormationPotentialEntry(
    ...
    description_observations: List[MultilingualTextField] = field(
        default_factory=list,
        metadata={
    ...
    quantitative_description: List[MultilingualTextField] = field(
        default_factory=list,
        metadata={
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntryField5295(
    BaseDataProtectionField
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalDataEntry(
    RepeatableEntryType
):
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictionsSimilarSubstancesWithExperimentalData:
    class Meta:
        global_type = False
...
@dataclass
class EndpointStudyRecordRadicalFormationPotentialResultsAndDiscussionAdditionalInformationAboutApplicabilityDomainAndReliabilityOfQsarpredictions:
    class Meta:
        global_type = False
