...
from platform_container_6_8.models.platform_attachment import (
    Attachment,
    AttachmentRef,
)
from platform_container_6_8.models.platform_metadata import (
    CreationDate,
    CreationTool,
    DefinitionVersion,
    DocumentKey,
...
from platform_container_6_8.models.platform_modification_history import (
    Modification,
)
